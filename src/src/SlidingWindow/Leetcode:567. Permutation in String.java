...
//Calculation of the Index whose charater to be removed is done as:Window is pf fixed length i.e. window so what ever the increased index be the i-window will keep the index in length or in range of the window length.
